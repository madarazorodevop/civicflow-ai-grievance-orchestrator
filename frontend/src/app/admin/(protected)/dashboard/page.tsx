...
export default function AdminDashboard() {
  ...
  const kpis = [
    ...
    { label: 'SEVERE RISK', value: stats.severe_risk, color: 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-300' },
  ...
  const priorityQueue = complaints
    .filter(c => (c.riskLevel === 'SEVERE' || c.riskLevel === 'MEDIUM') && c.status !== 'Resolved')
    .sort((a, b) => a.riskLevel === 'SEVERE' ? -1 : 1)
    .slice(0, 5);
